...
function NodeCheckbox({attrs, node, className, formatMessage}) {
  const [checked, setChecked] = useState(attrs.value);
...
export const Node = ({
  ...
  if (isUiNodeImageAttributes(node.attributes)) {
    ...
    switch (nodeType) {
      ...
      case "datetime-local":
      case "checkbox":
        return (<NodeCheckbox attrs={attrs} className={className} formatMessage={formatMessage} node={node} /> );
      default:
        return (
          <div
